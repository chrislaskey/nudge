...
// License: LGPL v2.1
//
// Modified for new Store() chrome.storage.local async interface
    ...
    Bundle = new Class({
        ...
        "initialize": function (params) {
            ...
            if (this.params.name !== undefined) {
				var that = this;
				settings.get(this.params.name, function(value){
                	that.set(value, true);
            		that.params.searchString = that.params.searchString.toLowerCase();
				});
            }else{
